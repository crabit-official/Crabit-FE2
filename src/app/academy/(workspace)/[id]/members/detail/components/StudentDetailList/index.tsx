...
function StudentDetailList({ academyId }: IStudentDetailList) {
  const { data: students, fetchNextPage, hasNextPage, isFetching, isError } = useGetInfiniteAcademyMemberDetailList(5, academyId);
