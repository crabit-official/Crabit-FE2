...
function StudentDetailList({ academyId }: IInstructorStudentList) {
  const { data: students, fetchNextPage, hasNextPage, isFetching, isError } = useGetInfiniteAcademyStudentList(5, academyId);
