...
function CheckBox({ label, id, disabled, register, required, errors }: ICheckboxProps) {
  return (
    <label className="flex w-fit items-center gap-2 pl-1">
      ...
      <div className="flex size-5 cursor-pointer items-center justify-center rounded-md border-solid border-amber-100 bg-neutral-100 text-transparent peer-checked:bg-main-pink peer-checked:text-white">
        <IoCheckmarkSharp />
      </div>
